    ...
    en: {
        translation: {
            ...
            cityIntro: {
                ...
                heroSubtitle: 'Dalat: The Marvelous Essence of a Blessed Land.',
                discovery: 'The Discovery',
                discoveryTitle: 'Dr. Alexandre Yersin found this haven above the clouds.',
                ...
                plateauDesc: 'Perched on the Lam Vien Plateau, Dalat enjoys year-round temperatures between 14°C and 28°C. While the rest of Vietnam swelters in tropical heat, the highlands remain an eternal spring.',
                yearRound: 'Year-round',
                elevation: 'Elevation',
                heritage: 'Heritage',
                heritageTitle: '2,000 French villas still stand',
                heritageP1: 'TThe previous era left behind an architectural legacy unlike any other in Southeast Asia. Pastel-colored villas, Gothic churches, and Art Deco hotels dot the hillsides—a living museum of early 20th-century European design.',
    ...
    vi: {
        translation: {
            ...
            weather: {
                ...
                dalatHighlands: 'Cao nguyên Lâm Viên',
            ...
            cityIntro: {
                ...
                heroSubtitle: 'Đà Lạt - Kết tinh kỳ diệu từ đất lành.',
                discovery: 'Khám Phá',
                discoveryTitle: 'Bác sĩ Alexandre Yersin đã khám phá thiên đường này trên mây.',
                ...
                plateau: 'Cao Nguyên',
                plateauTitle: '1.500 mét so với mực nước biển',
                plateauDesc: 'Nằm trên Cao nguyên Lâm Viên, Đà Lạt được hưởng nhiệt độ quanh năm. Trong khi phần còn lại của Việt Nam oi bức trong nóng nhiệt đới, Đà Lạt vẫn là mùa xuân vĩnh hằng.',
                yearRound: 'Quanh năm',
                elevation: 'Độ cao',
                heritage: 'Di Sản',
                heritageTitle: '2.000 biệt thự Pháp vẫn còn đứng vững',
                heritageP1: 'Thời kỳ trước đã để lại di sản kiến trúc không giống bất kỳ nơi nào khác ở Đông Nam Á. Những biệt thự màu pastel, nhà thờ Gothic và khách sạn Art Deco nằm rải rác trên các sườn đồi—một bảo tàng sống của thiết kế châu Âu đầu thế kỷ 20.',
